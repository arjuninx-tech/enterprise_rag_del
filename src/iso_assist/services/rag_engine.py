"""
rag_engine.py - RAG Engine for ISO Manual Assistant
...
from iso_assist.services.prompts import (
    build_rag_prompt,
    build_prompt_with_attachments,
    NOT_FOUND_RESPONSE,
    SYSTEM_PROMPT,
    SYSTEM_PROMPT_WITH_ATTACHMENTS,
)
from iso_assist.utils.logger import log_question, log_error
...
def ask_stream(question, chunks=None, model=None, attached_context: str = ""):
    ...
    def _run():
        ...
        if has_attachments:
            ...
            active_system = SYSTEM_PROMPT_WITH_ATTACHMENTS
        else:
        ...
        not_found = (
            "not available in the approved documents" in answer_lower
