...
Run directly to (re)build the knowledge base:
    python -m iso_assist.services.ingest
"""
...
from iso_assist.services.document_loader import load_all_documents
from iso_assist.utils.logger import log_error
from iso_assist.services.rag_engine import reset_collection_cache
