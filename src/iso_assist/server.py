...
from iso_assist.config import SUPPORTED_EXTENSIONS
from iso_assist.desktop import Api
from iso_assist.models.chat_store import init_db
...
def upload_attachment():
    ...
    try:
        ...
        from iso_assist.models.doc_memory import attach_document
...
def main():
    ...
    print("\n  Private RAG Workbench - Web Mode")
